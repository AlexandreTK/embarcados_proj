...
class SettingsTest < ApplicationSystemTestCase
  ...
  test "creating a Setting" do
    ...
    fill_in "Minutes to next action", with: @setting.minutes_to_next_action
    fill_in "Operation type", with: @setting.operation_type
    fill_in "Timezone hours diff", with: @setting.timezone_hours_diff
